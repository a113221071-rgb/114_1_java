...
public class AccountTest {
    public static void main(String[] args) {
        ...
        Account acc1 = new Account("A001", "Alice", "A113221071", 5000);
        addCustomer(customers, acc1);
        Account acc2 = new Account("A002", "Bob","A113221071", 3000);
        addCustomer(customers, acc2);
        Account acc3 = new Account("A003", "Charlie","A113221071", -100);
